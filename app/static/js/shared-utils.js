...
export function initializeDefaultAvatars() {
    const profileImages = document.querySelectorAll('img[data-user-name]');
...
export function addUserDropdownHTML(username, role, pfpPath) {
